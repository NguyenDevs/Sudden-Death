...
public class BleedingFeature extends AbstractFeature {
    ...
    public void onEntityRegainHealth(EntityRegainHealthEvent event) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.WARNING, "Error in BleedingFeature.onEntityRegainHealth", e);
        }
    }
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.WARNING, "Error in BleedingFeature.onPlayerMove", e);
        }
    }
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        try {
            ...
            data.setBleeding(false);
            player.sendMessage(ChatColor.translateAlternateColorCodes('&',
                    Utils.msg("prefix") + " " + Utils.msg("use-bandage")));
            player.playSound(player.getLocation(), Sound.ITEM_ARMOR_EQUIP_LEATHER, 1.0f, 0.0f);
        } catch (Exception e) {
            plugin.getLogger().log(Level.WARNING, "Error in BleedingFeature.onPlayerInteract", e);
        }
    }
