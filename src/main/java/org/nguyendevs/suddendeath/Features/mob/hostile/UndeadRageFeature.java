...
public class UndeadRageFeature extends AbstractFeature {
    ...
    private void applyUndeadRage(Zombie zombie) {
        ...
        zombie.getWorld().spawnParticle(Particle.ANGRY_VILLAGER, zombie.getLocation().add(0, 1.7, 0), 6, 0.35, 0.35, 0.35, 0);
        zombie.addPotionEffect(new PotionEffect(PotionEffectType.STRENGTH, duration, 1));
